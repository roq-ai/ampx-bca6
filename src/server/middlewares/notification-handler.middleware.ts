...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Order #123 has been placed by customer John Doe.create': {
    roles: ['business-owner', 'staff-member', 'manager', 'administrator'],
    key: 'order_create',
    tenantPath: [],
    userPath: [],
  },
  'Product XYZ stock has been updated by staff member Jane Doe.update': {
    roles: ['business-owner', 'staff-member', 'manager', 'administrator'],
    key: 'inventory_update',
    tenantPath: [],
    userPath: [],
  },
  'Appointment with customer John Doe has been scheduled by manager Jane Doe.create': {
    roles: ['business-owner', 'staff-member', 'manager', 'administrator'],
...
const tenantRoles: string[] = ['business-owner', 'staff-member', 'manager', 'administrator', 'end-customer'];
