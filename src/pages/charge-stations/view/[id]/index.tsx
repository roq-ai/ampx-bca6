...
import { getChargeStationById } from 'apiSdk/charge-stations';
import { ChargeStationInterface } from 'interfaces/charge-station';
import { ChargingHistoryListPage } from 'pages/charging-histories';

function ChargeStationViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('charge_station', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/charge-stations/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Charging Speed" text={data?.charging_speed} />
