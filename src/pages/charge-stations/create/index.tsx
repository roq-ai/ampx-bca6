...
import { createChargeStation } from 'apiSdk/charge-stations';
...
function ChargeStationCreatePage() {
  ...
  const handleSubmit = async (values: ChargeStationInterface, { resetForm }: FormikHelpers<any>) => {
    setError(null);
    try {
      await createChargeStation(values);
      resetForm();
