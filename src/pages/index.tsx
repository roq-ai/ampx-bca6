  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience AMPX, where booking appointments for charging has never been easier. A seamless solution for your charging needs."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1511871893393-82e9c16b81e3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxib29raW5nfGVufDB8fHx8MTY5NTQxMjE4OXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@jeshoots?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`JESHOOTS.COM`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience AMPX, where booking appointments for charging has never been easier. A seamless solution for your charging needs.`}
            </Text>
            <Box
